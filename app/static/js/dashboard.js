...
function createNoteCard(note) {
    ...
    return `
        <div class="note-card" onclick="window.location='{{ url_for('main.note_editor') }}'">
...
function createDeckCard(deck) {
    ...
    return `
        <div class="deck-card" onclick="window.location='{{ url_for('main.flashcard_editor') }}'">
            <div class="deck-card-content">
                <div class="deck-card-header">
                    <a href="{{ url_for('main.flashcard') }}" class="deck-play-btn" >
